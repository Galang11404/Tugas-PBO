...
import LIMAS_SEGIEMPAT
def hitung_luas():
    LS_1 = float(txtLS_1.get())
    LS_2 = float(txtLS_2.get())
    LS_3 = float(txtLS_3.get())
    LS_4 = float(txtLS_4.get())
    LS_5 = float(txtLS_5.get())
    luas = LIMAS_SEGIEMPAT.hitung_luas(LS_1,LS_2,LS_3,LS_4,LS_5)
...
def hitung_volume():
    T = float(txtT.get())
    a = float(txta.get())
    volume = LIMAS_SEGIEMPAT.hitung_volume(T,a)
...
app.title("Penghitung Luas dan Volume Limas Segiempat")
...
judul = Label(frame, text="Hitung Luas dan Volume Limas Segiempat", font=("Arial", 12, "bold"), bg="#f0f0f0")
judul.grid(row=0, columnspan=2, pady=10)

LS_1 = Label(frame, text="Luas Segiempat 1: ", bg="#f0f0f0")
LS_1.grid(row=1, column=0, sticky=W, padx=5, pady=5)

LS_2 = Label(frame, text="Luas Segiempat 2: ", bg="#f0f0f0")
LS_2.grid(row=2, column=0, sticky=W, padx=5, pady=5)

LS_3 = Label(frame, text="Luas Segiempat 3: ", bg="#f0f0f0")
LS_3.grid(row=3, column=0, sticky=W, padx=5, pady=5)

LS_4 = Label(frame, text="Luas Segiempat 4: ", bg="#f0f0f0")
LS_4.grid(row=4, column=0, sticky=W, padx=5, pady=5)

LS_5 = Label(frame, text="Luas Segiempat 5: ", bg="#f0f0f0")
LS_5.grid(row=5, column=0, sticky=W, padx=5, pady=5)
...
a.grid(row=7, column=0, sticky=W, padx=5, pady=5)
...
txtLS_5 = Entry(frame, bg="lightgray", fg="black", font=("Arial", 12))
txtLS_5.grid(row=5, column=1)
